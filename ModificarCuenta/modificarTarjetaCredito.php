...
// Check connection
  ...
  $sql = "SELECT NumberCard,SecurityCode FROM Users JOIN Card Using(Id_Card) WHERE Id_User ='".$Id."'";
...
<title>Modificar Tarjeta de Crédito</title>
<meta charset="UTF-8">
...
<body style="background-color: #999999;">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="login100-more" style="background-image: url('imagenes1/puppy1.jpg');"></div>
      <form action="modificarTarjetaCredito1.php" method="post">
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form class="login100-form validate-form">
          ...
          <div class="wrap-input100 validate-input" data-validate = "Número de la Tarjeta de Crédito es requerido">
            ...
            <input class="input100" id="cardnumber" type="text" value="<?php echo $registro[0] ?>"  pattern="[0-9]{4}\s[0-9]{4}\s[0-9]{4}\s[0-9]{4}" placeholder="4000 1234 5678 9010" name="cardnumber" required>
          ...
          <div class="wrap-input100 validate-input" data-validate = "Código de seguridad es requerido">
            ...
            <input class="input100" id="seccode" type="text" value="<?php echo $registro[1] ?>" pattern="[0-9]{3}" placeholder="000" name="seccode" required>
            <span class="focus-input100"></span>
          </div>
          <div>
